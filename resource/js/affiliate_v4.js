jQuery(document).ready(function($) {
	...
	var rakutenPromiz = function(barcode) {
	  return new Promise(function(resolve, reject) {
	    ...
	    .done(function(data) {
	    	// console.log("Rakuten Data Ahsan Ullah");
	    	// console.log(data);
	    	resolve(data);
	    	// console.log('success');			
	    })
	...
	$("#save_introduce").click(function(event) {
		...
		if (owner_name !=='' && owner_phone !=='' && introduce_name !== '' && introduce_phone !=='') {
			...
			.done(function(data) {
				...
				// $("#introduce_sms_link").attr('href', 'sms:'+introduce_phone+'?body='+base_url+'account/sign_up?intorid='+data);
