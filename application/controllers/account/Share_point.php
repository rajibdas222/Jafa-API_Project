 ...
 */
class Share_point extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('account/account_model', 'account/account_details_model'), 'account/share_point_model');
	...
	function index($action = NULL)
	{
		...
		$data['all_users'] = $this->account_model->get_shoper();
		// echo $this->db->last_query();
		// echo "<pre>"; print_r($data['all_users']);
		// exit();
		...
		$this->load->view('account/share_point', $data);
	}
