...
<div class="container">
    <div class="row">
			...
			<?php if (isset($profile_info))
		{
            ...
            <div class="form-group <?php echo (form_error('profile_username')) ? 'has-error' : ''; ?>">
                <label class="col-md-3 control-label" for="profile_username"><?php echo lang('profile_username'); ?></label>

                <div class="col-md-5">
					<?php echo form_input(array('name' => 'profile_username', 'id' => 'profile_username', 'class'=>'form-control', 'value' => set_value('profile_username') ? set_value('profile_username') : (isset($account->username) ? $account->username : ''), 'maxlength' => '24')); ?>
