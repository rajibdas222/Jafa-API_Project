...
<div class="container-fluid" style="margin-top: 20px;">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="<?= base_url('account/account_profile') ?>"
               style=" font-size: 26px; text-decoration: underline; color: #000;"> <?= $fullname ?></a><span
                    style="font-size: 26px"> 様</span>
        </div>
        ...
        <div class="col-md-6" style="font-size: 28px;">
            ...
            <button class="btn btn-danger btn-lg float-right" id="new_member_reg_btn" style="margin-right: 10px;"><i
                        class="fa fa-user-plus"></i> 新規登録
            </button>
            <a href="company_point" class="btn btn-secondary btn-lg float-right" style="margin-right: 10px;">My
                Point</a>
        ...
        <div class="col-md-12">
            <div class="float-right" style="font-size: 26px; padding-bottom: 10px;">
                <a class="btn btn-secondary" id="csv_download"
                   href="<?= base_url() ?>main_controller/download_member_point/<?= $account->id ?>"><i
                            class="fa fa-download"></i> Download</a>
                <button id="report_period" style="" class="btn btn-warning btn-lg">期間</button>
                <span id="show_dateSetting">
							<?php echo date('Y年の') . date('m月') . date('1日') . '～' . date('m月末日'); ?>
						</span>
                </span>

                <input style="margin-top: 20px; position: fixed; border:none; width: 1px; height: 1px;"
                       id="select_month_datepicker">

            </div>
        </div>
        <div class="col-md-12" style="margin-top: 20px;">
            <table id="company_member_list" class="table table-bordered"
                   style="font-size: 26px; border: 3px solid blue;">
                <thead>
                <tr>
                    <th>会員</th>
                    <th>トラッキングID</th>
    ...
    <div class="card d-block screen_message"
         style="position: fixed; right: 30px; bottom: 10px; padding: 4px; background: #FFCCFF;">
        <div class="card-body">
            <p style="font-size: 22px;">
                会員名を押すと、明細が表示されます。
            </p>
            <center>
                <button class="btn btn-info" id="close_scerren_message">確認</button>
            </center>
        </div>
    </div>
    <div class="card d-none col-lg-3 col-md-4 col-sm-12 new_member_registration_screen" id="member_reg_form"
         style="position: fixed; right: 30px; bottom: 10px; background: #f0ffcc; padding: 0">
        <div class="card-header">
            <!-- <center><h4>加盟店登録</h4></center>  -->
            <center><h4>新規登録</h4></center>
        </div>
        <div class="card-body">
            <form class="form-horizontal" action="/manage_users/compay_save" method="post">
                <input type="hidden" name="request_url" value="company_margine">
                <fieldset>
                    <table class="table table-striped" style="margin-bottom: 0">
                        <tr>
                            <th style="border-color: #dee2e6" width="30%"><label class="control-label" for="owner_name">加盟店名</label>
                            </th>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <center>
                                    ...
                                    <button style="font-size: 22px; width: 100px;" id="" name="close_introduce_screen"
                                            class="btn btn-warning new_member_reg_form_close">戻る
                                    </button>
                                </center>
    ...
    <div class="card d-none member_item col-md-10"
         style="position: fixed; right: 100px; bottom: 10px; padding: 4px; background: #FFFF99; min-height: 600px;">
        <div class="card-body">
            <div class="col-md-12">
                ...
                .done(function (data) {
                    ...
                    if (response.members.length > 0) {
                        ...
                        for (var i = 0; i < response.members.length; i++) {
                            ...
                            var temp_jafa_point = temp_point_amount - (temp_company_point + temp_member_point);
                            ...
                            var perm_jafa_point = perm_point_amount - (perm_company_point + perm_member_point);
