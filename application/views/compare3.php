...
<head>
	...
	<link rel="apple-touch-icon" size="152x152" href="<?php echo base_url().RES_DIR; ?>/pwa/charin2_152.png?id=<?php echo rand(0,10000)?>">
  	<link rel="icon" type="image/png" size="152x152" href="<?php echo base_url().RES_DIR; ?>/pwa/charin2_152.png?id=<?php echo rand(0,10000)?>">
  	<!-- Launcher Icon for Android and iPhone -->

	<link rel="stylesheet" type="text/css" href="<?php echo base_url().RES_DIR; ?>/bootstrap/dist/css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().RES_DIR; ?>/css/style_v2.css?id=<?php echo rand(0,10000)?>">
...
<body>
			...
			<div class="col-sm-8 desktop_show ">
				<ul class="nav float-right">
				  ...
				  <?php
					...
					?>
				  <li class="nav-item">
				    <a href="<?= base_url() ?>account/sign_out" class="btn btn-default btn-lg text-center home_page_button" id="">ログアウト</a>
				  </li>
				  <li class="nav-item">
				...
				?>
				  <li class="nav-item">
				  	<button class="btn btn-default btn-lg text-center home_page_button introduce_btn" id="">紹介問い合わせ</button>
				  </li>
				</ul>
				<?php
				//if (!$this->authentication->is_signed_in()) {?>
		...
		<div class="main_border">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="row desktop_show">
						<div class="col-sm-6 offset-3 app-title" style="background-color: #7DCFF7; margin-bottom: 10px; padding: 10px; border: 2px solid blue; border-radius: 4px;">
							...
							<button class="btn btn-lg search_scroll_btn float-right" style="padding: 0px;">
								<p style="font-size:24px; margin-right: 55px; margin-top: -10px; padding: 10px 10px; text-align: left; color: white;" class="btn">消費税をぶっ飛ばそう!</p>
							</button>
					...
					<div class="row mobile_show">
						...
						<div class="col-sm-12">
							<a href="#" class="btn btn-lg search_scroll_btn">消費税をぶっ飛ばそう!</a>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 offset-md-3">
							<div class="heading2-box">
								...
								<div class="float-left" style="width: 96%">
									<p class="" style="">
										配送料の関係もあり、１つのサイトで連続して購入できます。<br>
										それらには、すべて<span style="color: white; background-color: #e70c81">ダブルポイント(D.P)</span> が付与されます。
									</p>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<p class="heading2-box box_message_shadew">
								<span class="" style="color: blue; font-weight: bold;">ショールーミング</span> <br>
				...
				<div class="col-sm-12 col-md-2 btn_aria_mobile">					
					...
					<button class="btn btn-default btn-lg text-center user_login_btn home_page_button" id="user_login_btn">ログイン</button>
						...
						?>
							...
							<a href="<?= base_url() ?>account/sign_out" class="btn btn-default btn-lg text-center home_page_button" id="">ログアウト<span class="float-right">></span></a>
					...
					?>
					<button class="btn btn-default btn-lg text-center home_page_button introduce_btn" id="" style="margin-right: 0;">紹介問い合わせ</button>
					<!-- <span class="btn-sparate"></span> -->
				</div>   
			</div>
					...
					<!-- <form class="form-inline" action="false"> -->
						<div class="row">
							...
							<span class="float-right qrcode_pc">
								...
								<img class="float-left" width="100" style="" src="resource/img/qrcode_pc.JPG">
								<button style="margin: 10px; margin-top: 25px;" class="float-right btn btn-default btn-lg jafa_btn float-left"><i class="fa fa-arrow-left"></i> 紹介QRコード</button>
						...
						<div class="form-group col-sm-12" style="margin-bottom: 5px; padding: 0;">
							...
							<div class="mobile_show row" style="margin-bottom: 5px;">
								<div class="clearfix"></div>
								<div class="col-sm-12">
									<button class="btn site_link_qrcode">
										<span>紹介用ＱＲコード </span><img class="float-right" width="70" style="" src="resource/img/qrcode_pc.JPG">	
									</button>
								</div>						
							</div>
							<button id="start-record-btn" style="margin-left: 5px; font-size: 26px;" class="btn btn-default jafa_btn btn-lg microphone microphone_btn float-left" type="button" style="">
								<div>
									<span class="microphone_icon">
										<i id="" class="fa fa-microphone-alt"></i>
									</span> 
							...
							<button style="margin-left: 5px; font-size: 26px;" class="btn btn-default btn-lg jafa_btn float-left" id="point_table_btn">ポイント残高</button>
							<?php
							if (!empty($account_role) && $account_role->role_id == 1) {
								?>
								<button style="margin-left: 5px; font-size: 26px;" id="purchase_history" class="btn btn-default btn_link btn-lg jafa_btn float-left">履歴</button>
								<?php
							...
							?>
							<button style="margin-left: 5px; font-size: 26px;" id="purchase_history" class="btn btn-default btn-lg jafa_btn float-left">履歴</button>
							<?php
							}
							?>
					...
					<table class="table compare_table" style="background: white; font-size: 22px;">
						<thead>
							<tr>
								...
								<th colspan="2" style="background-color: #CBEBF6; border-bottom: 1px solid #00A0E8; border-top: none; border-right: none; ">
								</th>
							</tr>
						...
						<tbody id="comparing_table">
							<tr>
								...
								<th  style="width: 5%" class="align-middle text-center" nowrap>サイト</th>
							</tr>
							<?php
							for ($i=0; $i < 3; $i++) { ?>
								<tr>
									...
									<td class="text-center"><button class="btn btn-warning btn-lg">購入へ</button></td>
								</tr>
								<?php
							}
							?>
			...
			<div class="card point_table_aria d-none" style="background: #eee;position: fixed; right: 10px; bottom: 5px; padding: 0; border:2px solid #3D618C;">
				...
				<div class="card-body bg-white">					
					<div class="row">
						<div class="card d-none cornvert_point_condition_less_aria" id="" style="background: #eee;position: fixed; right: 40px; bottom: 100px; padding: 0; border:2px solid #3D618C; z-index: 1000">
							<div class="card-header">
								<div class="row">
									<div class="col-sm">
										<button class="btn btn-danger float-right btn-sm cornvert_point_condition_less_aria_close float-right" id="">戻る</button>
									</div>
								</div>
							</div>
							<div class="card-body bg-white">	
					...
					<div class="row">
						<div class="card d-none cornvert_point_condition_less_aria" id="" style="background: #eee;position: fixed; right: 40px; bottom: 100px; padding: 0; border:2px solid #3D618C; z-index: 1000">
							...
							<div class="card-body bg-white">	
								...
								<div class="row">
									<div class="col-sm">
										<p class="condition_less_content_aria" id="">
											500ポイント未満なので、交換できません。
										</p>
									</div>
								...
								<form>
								  ...
								  <div class="form-group row">
								      ...
								      <div class="" style="width: 40%; padding-right: 15px;">
								      	...
								      	<select class="form-control point_convert_amount desktop_show" id="">
	...
	<script type="text/javascript" src="<?php echo base_url().RES_DIR; ?>/bootstrap/dist/js/bootstrap.js?id=<?php echo rand(0,10000)?>"></script>
	<script type="text/javascript" src="<?php echo base_url().RES_DIR; ?>/js/qrcodelib.js?id=<?php echo rand(0,10000)?>"></script>
	<!-- <script type="text/javascript" src="<?php echo base_url().RES_DIR; ?>/js/webcodecamjquery.js"></script> -->
	
	<script type="text/javascript" src="<?php echo base_url().RES_DIR; ?>/js/xml2json.js?id=<?php echo rand(0,10000)?>"></script>
	
    <script src="https://cdn.rawgit.com/serratus/quaggaJS/0420d5e0/dist/quagga.min.js?id=<?php echo rand(0,10000)?>"></script>
    ...
    <style>
	  ...
	  <script type="text/javascript" src="<?php echo base_url().RES_DIR; ?>/pwa/app.js?id=<?php echo rand(0,10000)?>"></script>
