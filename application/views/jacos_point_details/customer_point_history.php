                ...
                <div class="card-header jacos-bg">
                    <div class="row">
                        ...
                        <div class="col-4"><h3 class="modal-title ml-2"><span
                                        id="Point_details_header">個人別 ポイント明細</span><span style="color: red">(履歴)</span> </h3></div>
                        <div class="col-4"><h3 class="details_result mr-2">a＋ｂ－ｃ＝ｄ(在庫管理と同一)</h3></div>
                        <div class="col-2">

                            <a class="btn btn-danger btn-lg" style="margin-bottom: 5px" href="<?= base_url() ?>">戻る</a>
                        </div>
