...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-header jacos-bg">
                    <div class="row">
                        ...
                        <div class="col-2 text-center d-flex">
                            <h5 id="companys_name" style="color: #000000; background: white;height: 28px;"></h5>
                            <h5 class="text-right" style="color: #050303"> 様</h5>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="card-body custom-table">
                        ...
                        <div class="point_aquisition_wrapper">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="company_memberlist_admin">
        ...
        <div class="card col-md-5 col-sm-12" id="admin_companylist_message" style="background-color: #55f893; border: 2px solid #486994; border-radius: 10px; position: fixed; max-width: 500px;
right: 10px;
bottom: 10px;
padding: 4px;">
            <div class="card-body">
...
<input type="hidden" id="company_user_id" name="company_user_id" value="<?= $company_user_id ?>">
...
<script>
    ...
    $(document).mouseup(function (e){
        var hide_enter_outside = $("#admin_companylist_message");
    ...
    $("#close_case_message").click(function(event) {
        ...
        $("#admin_companylist_message").removeClass('d-block').addClass('d-none');
    });
    ...
    function get_category_company() {
        ...
        $.get(base_url + 'Point_Acquisition/get_admin_allcompany_member/'+user_id, function (data) {
            var response = JSON.parse(data);
            //console.log(response, "admin_company_member_list");
            var tableHtml = '';
            ...
            $("#company_memberlist_admin").html(tableHtml);
