...
<body">
	...
	<div class="container-fluid" style="margin-top: 20px;">
		<div class="row">
			<div class="col-md-12">
				<div class="float-right">
					...
					<a class="btn btn-danger btn-lg" style="margin-bottom: 5px" href="<?= base_url() ?>admin/gift_code">戻る</a>
				</div>
				
			</div>
			<div class="col-md-4 offset-md-4">
				<h3 class="float-left">アマゾンギフト券追加</h3>
			</div>
		...
		<div class="row">
			...
			<hr>
				<form method="POST" action="<?= base_url() ?>admin/gift_code/add" enctype="multipart/form-data">
					
					<div class="form-group row">
						<label class="form-control-label col-md-3">申込日</label>
						<div class="col-md-9">
					...
					<div class="form-group row">
						...
						<div class="col-md-9">
							<button type="submit" name="submit_gifcode" class="btn btn-primary btn-lg">送信</button>
						</div>
					</div>
					<div class="row form-group">
						<label class="form-control-label col-md-3"></label>
						<div class="col-md-9">
							<a href="<?= base_url() ?>uploads/Sample GiftCode - Sheet1.csv" download class="btn btn-info btn-lg"><i class="fa fa-download"></i> アマゾンのサンプル</a>
						</div>
					</div>
				</form>
			</div>	   	
...
padding: 4px;">
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12">
						<center style="font-size: 20px; color: red;" ><?= form_error('file') ?>	</center>
						<center>
		...
		<?php
		if ($this->session->flashdata('add_gift_code') != "") :		?>
		<div class="card col-md-5 col-sm-12 product_case_message" id="" style="background-color: white; border: 2px solid #486994; border-radius: 10px; position: fixed; max-width: 500px;
right: 10px;
bottom: 10px;
padding: 4px;">
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12">
						<center style="font-size: 20px; color: green;" ><?= $this->session->userdata('add_gift_code') ?>	</center>
						<center>
							<button id="coo" class="btn btn-warning btn-lg close_case_message">確認</button>
						</center>
...
padding: 4px;">
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12">
						<center><p style="font-size: 24px;">ファイルを選択して「送信」を<br>押してください。</p>	</center>
						<center>
							<button id="coo" class="btn btn-warning btn-lg close_case_message">確認</button>
						</center>
