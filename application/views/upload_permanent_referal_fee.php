	...
	<div class="container-fluid" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="col-md-7" style="font-size: 28px;">
				...
				<a href="admin_company_point" class="btn btn-info btn-lg float-right" style="margin-right: 10px;">Company Point</a>
				<a href="upload_temp_referal_fee" class="btn btn-info btn-lg float-right" style="margin-right: 10px;">Upload Temporary Referal Fee</a>
			...
			<div class="col-md-4 offset-md-4" style="margin-top: 20px;">
				<form class="form-horizontal" action="<?= base_url() ?>main_controller/save_temp_referal_fee" method="post" name="upload_excel" enctype="multipart/form-data">
				  <div class="form-group">
				    <label for="exampleInputEmail1">Upload Permanent Raferal Fee</label>
				  ...
				  <a href="<?= base_url() ?>uploads/amazon-1563415500070-Fee-Earnings-5a487626-fe30-41ff-b66f-780a545a5398-XLSX - Fee-Earnings.csv" download class="btn btn-info"><i class="fa fa-download"></i> Download Sample File</a>
				</form>
			</div>		   	
		</div>
